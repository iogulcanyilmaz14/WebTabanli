<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WebTabanlı.Default" %>
...
<div id="container">
  <div id="header">
    ...
    <img src="images/logo.jpg" width="169" height="73" alt="" id="logo" /> <img src="images/slogan.gif" width="275" height="17" alt="" id="slogan" /> <img src="images/slogan2.jpg" width="267" height="60" alt="" id="slogan2" /> <a href="#"><img src="images/btn_learn.gif" alt="" name="btn_learn" width="107" height="24" border="0" id="btn_learn" /></a> </div>
  <div id="content">
    <div id="leftPan">
      <div id="welcome">
        <h2></h2>
        <img src="images/img_welcome.gif" width="184" height="78" alt="" />
    ...
    <div id="rightPan">
      <div id="featured">
        <h2></h2>
        <div id="leftFeat"> <img src="images/img_featured.gif" width="78" height="78" alt="" />
        ...
        <div id="rightFeat"> <img src="images/img_featured-14.gif" width="78" height="78" alt="" />
